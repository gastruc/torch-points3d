...
for u in [64]:
    ...
    tracker = dataset.get_tracker(False, True)
    print("Modèle 128 testé sur 124")
    test_epoch1_128('cuda',124,0,0)
    print(tracker.publish(0)['current_metrics']['acc'])
    print(tracker.publish(0)['current_metrics']['loss_class'])
    
    tracker = dataset.get_tracker(False, True)
    print("Modèle 128 testé sur 114")
    test_epoch1_128('cuda',114,0,0)
    print(tracker.publish(0)['current_metrics']['acc'])
    print(tracker.publish(0)['current_metrics']['loss_class'])
    
    tracker = dataset.get_tracker(False, True)
    print("Modèle 64 testé sur 114")
    test_epoch1_64('cuda',114,0,0)
    print(tracker.publish(0)['current_metrics']['acc'])
    print(tracker.publish(0)['current_metrics']['loss_class'])
    
    tracker = dataset.get_tracker(False, True)
    print("Modèle 64 testé sur 124")
    test_epoch1_64('cuda',124,0,0)
    print(tracker.publish(0)['current_metrics']['acc'])
    print(tracker.publish(0)['current_metrics']['loss_class'])
    
    tracker = dataset.get_tracker(False, True)
    print("Modèle 128 testé sur 64+10 plus loins des autres un par un:")
    test_epoch1_128('cuda',64,0,10)
    print(tracker.publish(0)['current_metrics']['acc'])
    print(tracker.publish(0)['current_metrics']['loss_class'])
    
    tracker = dataset.get_tracker(False, True)
    print("Modèle 128 testé sur 64+20 plus loins des autres un par un:")
    test_epoch1_128('cuda',64,0,20)
    print(tracker.publish(0)['current_metrics']['acc'])
    print(tracker.publish(0)['current_metrics']['loss_class'])
    
    tracker = dataset.get_tracker(False, True)
    print("Modèle 128 testé sur 64+30 plus loins des autres un par un:")
    test_epoch1_128('cuda',64,0,30)
    print(tracker.publish(0)['current_metrics']['acc'])
    print(tracker.publish(0)['current_metrics']['loss_class'])
    
    tracker = dataset.get_tracker(False, True)
    print("Modèle 128 testé sur 64+40 plus loins des autres un par un:")
    test_epoch1_128('cuda',64,0,40)
    print(tracker.publish(0)['current_metrics']['acc'])
    print(tracker.publish(0)['current_metrics']['loss_class'])
    
    tracker = dataset.get_tracker(False, True)
    print("Modèle 128 testé sur 64+50 plus loins des autres un par un:")
    test_epoch1_128('cuda',64,0,50)
    print(tracker.publish(0)['current_metrics']['acc'])
    print(tracker.publish(0)['current_metrics']['loss_class'])
    
    tracker = dataset.get_tracker(False, True)
    print("Modèle 128 testé sur 64+60 plus loins des autres un par un:")
    test_epoch1_128('cuda',64,0,60)
    print(tracker.publish(0)['current_metrics']['acc'])
    print(tracker.publish(0)['current_metrics']['loss_class'])
    
    tracker = dataset.get_tracker(False, True)
    print("Modèle 64 testé sur 64+10 plus loins des autres un par un:")
    test_epoch1_64('cuda',64,0,10)
    print(tracker.publish(0)['current_metrics']['acc'])
    print(tracker.publish(0)['current_metrics']['loss_class'])
    
    tracker = dataset.get_tracker(False, True)
    print("Modèle 64 testé sur 64+20 plus loins des autres un par un:")
    test_epoch1_64('cuda',64,0,20)
    print(tracker.publish(0)['current_metrics']['acc'])
    print(tracker.publish(0)['current_metrics']['loss_class'])
    
    tracker = dataset.get_tracker(False, True)
    print("Modèle 64 testé sur 64+30 plus loins des autres un par un:")
    test_epoch1_64('cuda',64,0,30)
    print(tracker.publish(0)['current_metrics']['acc'])
    print(tracker.publish(0)['current_metrics']['loss_class'])
    
    tracker = dataset.get_tracker(False, True)
    print("Modèle 64 testé sur 64+40 plus loins des autres un par un:")
    test_epoch1_64('cuda',64,0,40)
    print(tracker.publish(0)['current_metrics']['acc'])
    print(tracker.publish(0)['current_metrics']['loss_class'])
    
    tracker = dataset.get_tracker(False, True)
    print("Modèle 64 testé sur 64+50 plus loins des autres un par un:")
    test_epoch1_64('cuda',64,0,50)
    print(tracker.publish(0)['current_metrics']['acc'])
    print(tracker.publish(0)['current_metrics']['loss_class'])
    
    tracker = dataset.get_tracker(False, True)
    print("Modèle 64 testé sur 64+60 plus loins des autres un par un:")
    test_epoch1_64('cuda',64,0,60)
    print(tracker.publish(0)['current_metrics']['acc'])
    print(tracker.publish(0)['current_metrics']['loss_class'])
